...
if ( !is_undefined( lst_options ) ) {
    ...
    for( var i = 0; i < size; i++ ) {
        ...
        if ( check ) {
            ...
            var optInst;
            if (i == 0){
                optInst = instance_create( backX + offsetX, textInst.y + textInst.textHeight + optionSpacing * 3, optObj );
            }
            else{
                optInst = instance_create( backX + offsetX, textInst.y + textInst.textHeight + optionSpacing, optObj );
            }
